...
- PR F bloquea avance operativo mientras exista alerta activa `open` o `reviewing`: recogida, reporte de entrega y confirmacion de recepcion no llaman RPCs de avance hasta que admin resuelva la alerta.
