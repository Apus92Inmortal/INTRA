...
revoke execute on function public.get_request_ip() from public, anon;
grant execute on function public.get_request_ip() to authenticated, service_role;
...
declare
  ...
  v_ip_address inet := public.get_request_ip();
...
begin
  ...
  insert into public.shipment_declarations (
    ...
    coalesce(p_ip_address, v_ip_address),
