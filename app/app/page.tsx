                ...
                {dashboard.publishedTrips.length === 0 ? (
                  ...
                  <div className="space-y-3">
                    {dashboard.publishedTrips.map((trip) => (
                      <div key={trip.id} className="rounded-[24px] border border-gray-100 bg-white px-3.5 py-3 shadow-[0_18px_45px_-35px_rgba(11,44,74,0.28)] transition hover:-translate-y-0.5 hover:shadow-lg sm:px-5">
                        <div className="flex items-start justify-between gap-2">
                          <div className="flex min-w-0 items-start gap-2.5">
                            <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl bg-[#F2FBF6]">
                              <svg className="h-3.5 w-3.5 text-[#2ECC71]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                              </svg>
                            </div>
                            <div className="min-w-0 pt-0.5">
                              <div className="flex flex-wrap items-center gap-1.5">
                                <p className="text-base font-bold tracking-[-0.02em] text-[#0B2C4A] sm:text-lg">{trip.routeShortLabel}</p>
                                <TripAvailabilityBadge trip={trip} />
                              </div>
                              <div className="mt-1 flex flex-nowrap items-center gap-x-1.5 text-[10px] leading-none text-slate-400 sm:text-sm">
