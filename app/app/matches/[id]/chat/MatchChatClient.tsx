...
export default function MatchChatClient({
  ...
  return (
    <div className="flex min-h-[calc(100dvh-7rem)] flex-1 flex-col overflow-hidden rounded-none bg-[#EEF2F7] sm:min-h-[calc(100dvh-8rem)] sm:rounded-3xl sm:border sm:border-gray-200 sm:bg-white sm:shadow-sm">
