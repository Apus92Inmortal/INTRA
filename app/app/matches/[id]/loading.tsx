        ...
        <div className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
          ...
          <div className="space-y-6 px-6 py-6 sm:px-8">
              ...
              {Array.from({ length: 2 }).map((_, index) => (
                <section key={index} className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                  <div className="space-y-3">
                    ...
                    <div className="h-4 w-32 animate-pulse rounded-xl bg-slate-100" />
                    <div className="h-4 w-56 animate-pulse rounded-xl bg-slate-100" />
                  </div>
                </section>
              ))}
            </div>
            ...
            <section className="rounded-2xl border border-slate-200 bg-slate-50 p-5">
              <div className="space-y-3">
                <div className="h-6 w-36 animate-pulse rounded-xl bg-slate-200" />
