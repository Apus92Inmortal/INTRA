...
import { cancelActiveWaitingTravelerShipmentAction } from "@/app/app/_actions/shipment-actions";
import { IntraConfirmDialog } from "@/components/ui";

type DashboardActiveShipmentCancelMenuProps = {
  shipmentId: string;
};

export default function DashboardActiveShipmentCancelMenu({
  shipmentId,
}: DashboardActiveShipmentCancelMenuProps) {
  ...
  const handleConfirmCancel = () => {
    startTransition(async () => {
      ...
      const result = await cancelActiveWaitingTravelerShipmentAction(shipmentId);
  ...
  return (
    <>
      ...
      <IntraConfirmDialog
        ...
        description="El envío dejará de estar disponible para viajeros. Se devolverá a tu Wallet el valor reembolsable, descontando el costo de pasarela."
